...
const Courses: React.FC<IframeProps> = ({ width="100%" , height="70%" , src , title })=>{
            ...
            <section className='bg-white w-full h-100vh flex justify-center items-center gap-4 2xl:p-4 xl:p-4 lg:p-3 md:p-3 sm:p-1 xs:p-0 flex-col'>
                <div className='w-full h-full flex justify-center items-center 2xl:p-3 xl:p-3 lg:p-3 md:p-3 sm:p-0 xs:p-0 gap-4'>
                        <div className=' w-[30%] h-full p-4 gap-4 2xl:flex justify-start items-center flex-col lg:flex md:hidden sm:hidden xs:hidden border-r-2 border-neutral-300'>
                            ...
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#starter" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins uppercase'>Setup</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#history" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins uppercase'>History of the web</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#html" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>HTML</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#css" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>CSS</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#bootstrap" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>BOOTSTRAP CSS</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#javascript" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>JAVASCRIPT</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#react" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>REACT</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#tailwind" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>TAILWINDCSS</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#express" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>EXPRESS AND NODE</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#docker" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>DOCKER AND KUBERNATES</a>
                            </div>
                            <div className='w-full h-[5%] flex justify-center items-center'>
                                <a href="#project" rel='noopener noreferer' className='w-full h-full flex justify-start items-start text-black font-Poppins'>HANDS ON PROJECT</a>
                            </div>
                        </div>
                        <div className='overflow-scroll w-full h-full 2xl:p-4 xl:p-4 lg:p-3 md:p-3 sm:p-1 xs:p-0 gap-4' id="setup">
                                ...
                                <div className='w-full 2xl:h-[40%] xl:h-[50%] lg:h-[40%] md:h-[30%] sm:h-[50%] xs:h-[50%] p-4 2xl:mb-0 xl:mb-12 lg:mb-20 md:mb-20 sm:mb-12 xs:mb-12' id='history'>
                                ...
                                <div className='w-full 2xl:h-[100%] xl:h-[80%] lg:h-[90%] md:h-[70%] sm:h-40vh xs:h-[80%] mb-10 p-4' id='javascript'>
                                ...
                                <div className='w-full 2xl:h-[80%] xl:h-[80%] lg:h-[90%] md:h-[70%] sm:h-40vh xs:h-[80%] mb-10 p-4' id='tailwind'>
